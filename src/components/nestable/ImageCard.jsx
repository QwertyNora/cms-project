...
//   return (
//     <div
//       className="w-full max-w-xs border rounded-lg overflow-hidden shadow-md"
//       {...storyblokEditable(blok)}
//     >
//       {/* Card Image */}
//       {blok.card_image?.filename && (
...
//             src={blok.card_image.filename}
//             alt={blok.card_image.alt || "Card Image"}
//             layout="fill" // Fyller hela container (i detta fall 100% bredd och h-48 höjd)
//             objectFit="cover" // Används för att bilden ska täcka hela ytan utan att förvrängas
//           />
//         </div>
//       )}
